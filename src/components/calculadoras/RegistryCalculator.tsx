                      ...
                      >
                        ...
                        <td className="px-4 py-2 text-sm text-gray-700">
                          {index === RANGOS.length - 1
                            ? '$100.00 + 0.5% del exceso de $10000'
            ...
            <div className="mt-8 bg-gray-50 rounded-xl p-6 border border-gray-200 relative overflow-hidden results-section">
              ...
              <div className="space-y-3">
                ...
                {resultado.descuentoTerceraEdad > 0 && (
                  <div className="flex justify-between py-2 border-b text-brand-600">
                    <span>Descuento Tercera Edad (50%):</span>
                    <span className="font-medium">-${resultado.descuentoTerceraEdad.toFixed(2)}</span>
                  </div>
                )}

                <div className="flex justify-between py-3 bg-brand-50 px-4 rounded-lg mt-4">
              ...
              <div className="mt-4 text-sm text-gray-500 space-y-2">
                ...
                <p>* Para valores superiores a $40000.01 se aplica una tarifa base más 0.5% sobre el exceso de $10000.</p>
