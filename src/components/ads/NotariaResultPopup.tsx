...
export default function NotariaResultPopup({ isVisible, onClose }: NotariaResultPopupProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full relative overflow-hidden">
        ...
        <div className="bg-blue-600 text-white p-4">
          <h3 className="text-xl font-bold">Optimice su trámite</h3>
        </div>
          ...
          <div className="mt-6 flex flex-col gap-3">
            <div className="flex flex-col sm:flex-row gap-3">
              <a 
                ...
                className="flex-1 bg-green-500 text-white text-center py-2 px-4 rounded hover:bg-green-600 transition-colors flex items-center justify-center"
              >
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 bg-blue-600 text-white text-center py-2 px-4 rounded hover:bg-blue-700 transition-colors flex items-center justify-center"
              >
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <button 
              onClick={onClose}
              className="border border-gray-300 text-gray-700 text-center py-2 px-4 rounded hover:bg-gray-100 transition-colors"
            >
              Cerrar
            </button>
          </div>
