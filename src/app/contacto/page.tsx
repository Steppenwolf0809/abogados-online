      ...
      <div className="max-w-4xl mx-auto px-4 py-8 pt-24">
        ...
        <div className="flex justify-center mt-8">
          <div className="flex space-x-4">
            <Link href="/" className="text-brand-600 hover:text-brand-800 transition-colors">
              ← Volver al inicio
            </Link>
            <Link href="/calculadoras" className="text-brand-600 hover:text-brand-800 transition-colors">
              Calculadoras
            </Link>
            <Link href="/servicios" className="text-brand-600 hover:text-brand-800 transition-colors">
              Servicios
            </Link>
          </div>
        </div>
